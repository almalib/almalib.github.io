...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | comp-comp-module */ "comp-comp-module").then(__webpack_require__.bind(null, /*! ./comp/comp.module */ "./src/app/comp/comp.module.ts")).then(m => m.CompModule)
    }
    // {
    //   path: 'module',
