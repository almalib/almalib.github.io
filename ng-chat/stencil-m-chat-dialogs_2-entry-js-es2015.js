...
const MChatDialogs = class {
    ...
    render() {
        return (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-chat-dialogs" }, Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])(Dialog, { mess: this.dialogs })));
    }
};
/**
...
const MChatHeader = class {
    constructor(hostRef) {
        ...
        this.clickToAddDialog = Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "clickToAddDialog", 7);
    }
    /**
    ...
    render() {
        return (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-chat-header" }, Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "title-wrapper" }, Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "search custom-link", onClick: () => this.showModal() }, this.isShowModal ? (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "c-chat c-chat-search" })) : (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "c-chat c-chat-times", onClick: () => this.cancelSearchPersonalHandler() }))), Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "title" }, "Messages"), Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "add custom-link", onClick: () => this.clickToAddDialogHandler() }, Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "c-chat c-chat-cog hover-link" }))), this.isShowModal ? (this.categories.length ? (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("dialog-categories", { theme: "mobile", categories: this.categories })) : ("")) : (Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "modal-wrapper" }, Object(_index_063f1606_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "text", placeholder: "search", onInput: (e) => this.searchDialogsHandler(e) })))));
    }
    /**
     * search Dialogs
     * */
