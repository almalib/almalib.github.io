...
const SAdamChat = class {
    ...
    render() {
        return (Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "main-wrapper" }, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("main", null, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "container" }, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row" }, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-1 white-col" }, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-adam-navigate", { onVisibleContacts: () => this.visibleContacts(), logo: _mock_2d06f4a2_js__WEBPACK_IMPORTED_MODULE_2__["l"] })), Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-3" }, this.showContacts(this.contactsVisible)), Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col white-col" }, Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("section", { class: "chat" }, this.showChat(this.dialogVisible))), this.showProfile(this.profileVisible))))));
    }
    /**
        ...
        switch (content) {
            case "showChat":
                return (Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-adam-direct", { onVisibleUserProfile: () => {
                        this.visibleProfile();
                    }, onSearchPersonalMessage: () => this.searchPersonalMessages(), message: _mock_2d06f4a2_js__WEBPACK_IMPORTED_MODULE_2__["M"] }));
            case "noChat":
    ...
    showContacts(item) {
        if (item === true) {
            return (Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-adam-dialogs", { onSearchDialogs: () => this.searchDialogs(), onClickToDialog: () => {
                    this.toggleChat();
                }, dialogs: _mock_2d06f4a2_js__WEBPACK_IMPORTED_MODULE_2__["d"], categories: _mock_2d06f4a2_js__WEBPACK_IMPORTED_MODULE_2__["a"], onClickToCategory: () => this.clickToCategory() }));
        }
        else {
            return (Object(_index_53235049_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-adam-contacts", { theme: "comp", contacts: _mock_2d06f4a2_js__WEBPACK_IMPORTED_MODULE_2__["c"], disableInnerSearchContactState: this.disableInnerSearchContactState }));
        }
    }
    /**
     *
